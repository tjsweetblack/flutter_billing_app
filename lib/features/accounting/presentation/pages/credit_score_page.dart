...
class _CreditScorePageState extends State<CreditScorePage> {
  ...
  void _submitLoanRequest(String bankName) async {
    ...
    final loanData = {
      ...
      'riskLabel': fraudScore >= 80 ? 'BAIXO RISCO' : (fraudScore >= 60 ? 'MÉDIO RISCO' : (fraudScore >= 40 ? 'ALTO RISCO' : 'MUITO ALTO RISCO')),
      'riskClass': healthScore >= 80 && fraudScore >= 80 ? 'VERIFICADO' : (healthScore >= 60 ? 'BAIXO RISCO' : (healthScore >= 40 ? 'MÉDIO RISCO' : 'ALTO RISCO')),
      'transactions': accountingState.totalTransactions,
      ...
      'profit': accountingState.netProfit,
      ...
      'transactionsList': accountingState.transactions.map((t) => {
