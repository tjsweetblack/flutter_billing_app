...
class HiveDatabase {
  ...
  static const String accountingBoxName = 'accounting';
  ...
  static Future<void> init() async {
    ...
    Hive.registerAdapter(AccountingTransactionAdapter());

    // Open Boxes
    await Hive.openBox<ProductModel>(productBoxName);
    await Hive.openBox<ShopModel>(shopBoxName);
    await Hive.openBox<AccountingTransaction>(accountingBoxName);
  ...
  static Box<AccountingTransaction> get accountingBox => Hive.box<AccountingTransaction>(accountingBoxName);
